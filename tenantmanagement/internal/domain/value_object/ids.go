...
type UserID struct{ value pgtype.UUID }
...
func NewUserIDFromUUID(u uuid.UUID) UserID {
	return UserID{value: pgtype.UUID{Bytes: u, Valid: true}}
}
...
func (t *UserID) Scan(value interface{}) error { return t.value.Scan(value) }
func (t UserID) Value() (driver.Value, error)  { return t.value.Value() }

func (t UserID) Raw() pgtype.UUID { return t.value }
