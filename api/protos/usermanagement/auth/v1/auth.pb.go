...
const file_usermanagement_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"!usermanagement/auth/v1/auth.proto\x12\vapi.auth.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!usermanagement/user/v1/user.proto\"v\n" +
	...
	"\x05token\x18\x01 \x01(\v2\x12.api.auth.v1.TokenR\x05token2\xa5\x03\n" +
	"\vAuthService\x12I\n" +
	"\bRegister\x12\x1c.api.auth.v1.RegisterRequest\x1a\x1d.api.auth.v1.RegisterResponse\"\x00\x12@\n" +
	"\x05Login\x12\x19.api.auth.v1.LoginRequest\x1a\x1a.api.auth.v1.LoginResponse\"\x00\x12U\n" +
	"\fRefreshToken\x12 .api.auth.v1.RefreshTokenRequest\x1a!.api.auth.v1.RefreshTokenResponse\"\x00\x12C\n" +
	"\x06Logout\x12\x1a.api.auth.v1.LogoutRequest\x1a\x1b.api.auth.v1.LogoutResponse\"\x00\x12m\n" +
	"\x14UpdateSessionContext\x12(.api.auth.v1.UpdateSessionContextRequest\x1a).api.auth.v1.UpdateSessionContextResponse\"\x00BNZLgithub.com/MartinMurithi/storeforge/api/protos/usermanagement/auth/v1;authv1b\x06proto3"
