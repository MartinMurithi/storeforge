...
func MapGetRoleByIDResponseProtoToDTO(pbRes *rbacv1.GetRoleByIDResponse) dto.GetRoleByIDResponseDTO {
	return dto.GetRoleByIDResponseDTO{
		Role: MapRoleProtoToDTO(pbRes.Role),
	}
}
...
// MapCreateRoleResponseProtoToDTO converts the gRPC response to the final Gateway API response
func MapUpdateRoleResponseProtoToDTO(pbRes *rbacv1.UpdateRoleResponse) dto.UpdateRoleResponseDTO {
	return dto.UpdateRoleResponseDTO{
		Role:    MapRoleProtoToDTO(pbRes.Role),
